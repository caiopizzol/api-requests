...
def graphql_query_example():
    ...
    client = api.GraphQLClient(endpoint="https://countries.trevorblades.com/graphql")
...
async def async_graphql_example():
    ...
    client = api.AsyncGraphQLClient(endpoint="https://countries.trevorblades.com/graphql")
